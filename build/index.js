...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(104) ], __WEBPACK_AMD_DEFINE_RESULT__ = function() {
	"use strict";
}.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(37), __webpack_require__(112).setImmediate))
...
var _approvejs = __webpack_require__(66);

var _approvejs2 = _interopRequireDefault(_approvejs);

var _braintreeWeb = __webpack_require__(67);
  ...
  _createClass(CreditCard, [{
    ...
    value: function componentDidMount() {
      ...
      var _props = this.props,
          nonceToken = _props.nonceToken,
          cardStyle = _props.cardStyle;

      this.props.setLoader(true);
      var styles = cardStyle ? cardStyle : this.cardStyle;
      if (nonceToken) {
        var setLoadComplete = function setLoadComplete() {
          return _this2.props.setLoader(false);
        };
        var saveCreditCardDetails = function saveCreditCardDetails(data) {
          return _this2.props.saveCreditCardDetails();
        };
        _braintreeWeb.client.create({
          ...
          _braintreeWeb.hostedFields.create({
            client: clientInstance,
            styles: styles,
            ...
            hostedFieldsInstance.on('validityChange', function (event) {
              ...
              var cardholderName = (0, _jquery2.default)('#cardholder-name')[0].value;
              var result = _approvejs2.default.value(cardholderName, {
              ...
              if (formValid && result.errors.length <= 0) {
                ...
                (0, _jquery2.default)('#button-pay').addClass('show-button');
              } else {
                (0, _jquery2.default)('#button-pay').removeClass('show-button');
              }
            });

            hostedFieldsInstance.on('empty', function (event) {
              (0, _jquery2.default)('header').removeClass('header-slide');
              (0, _jquery2.default)('#card-image').removeClass();
              (0, _jquery2.default)(form).removeClass();
              if ((0, _jquery2.default)('#modal-content').hasClass('model-content-background')) {
                (0, _jquery2.default)('#modal-content').removeClass('model-content-background');
              }
            });
            ...
            hostedFieldsInstance.on('cardTypeChange', function (event) {
              ...
              if (event.cards.length === 1) {
                (0, _jquery2.default)(form).removeClass().addClass(event.cards[0].type);
                (0, _jquery2.default)('#card-image').removeClass().addClass(event.cards[0].type);
                (0, _jquery2.default)('header').addClass('header-slide');
                (0, _jquery2.default)('#cardholder-name').removeClass().addClass(event.cards[0].type);
                if (!(0, _jquery2.default)('#modal-content').hasClass('model-content-background')) {
                  (0, _jquery2.default)('#modal-content').addClass('model-content-background');
                }
            ...
            submit.addEventListener('click', function (event) {
              event.preventDefault();
              var cardholderName = (0, _jquery2.default)('#cardholder-name')[0].value;
              var primary = (0, _jquery2.default)('#primary')[0].checked;
              hostedFieldsInstance.tokenize({
    ...
    value: function handleNameChange(_ref) {
      ...
      var _approve$value = _approvejs2.default.value(value, {
        title: 'cardholderName',
        required: true,
        format: {
          regex: /^[A-Za-z/ ]+$/,
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          nameErrors = _state.nameErrors,
          cardholderNameFocused = _state.cardholderNameFocused;
      var loadingBraintree = this.props.loadingBraintree;

      return _react2.default.createElement(
        'div',
        { className: 'creditCardAdd form-control' },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'label',
                { className: 'cardinfo-label', htmlFor: 'card-number' },
                'Card Number'
              ),
              _react2.default.createElement('div', { className: 'input-wrapper', id: 'card-number' }),
              _react2.default.createElement('div', { id: 'card-image' })
            ),
            _react2.default.createElement(
              'div',
              { className: 'cardinfo-card-holder-number' },
              _react2.default.createElement(
                'label',
                { className: 'cardinfo-label', htmlFor: 'card-holder-number' },
                'Card Holder Name'
              ),
              _react2.default.createElement(
                'div',
                {
                  className: 'input-wrapper ' + (nameErrors && nameErrors.length > 0 && 'braintree-hosted-fields-invalid') + ' ' + (cardholderNameFocused ? 'braintree-hosted-fields-focused' : ''),
                  id: 'card-holder-number',
                  onFocus: function onFocus() {
                    return _this3.setState({ cardholderNameFocused: true });
                  },
                  onBlur: function onBlur() {
                    return _this3.setState({ cardholderNameFocused: false });
                  } },
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'cardinfo-exp-date' },
                _react2.default.createElement(
                  'label',
                  { className: 'cardinfo-label', htmlFor: 'expiration-date' },
                  'Valid Thru'
                ),
                _react2.default.createElement('div', { className: 'input-wrapper', id: 'expiration-date' })
              ),
              _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                  'label',
                  { className: 'cardinfo-label', htmlFor: 'cvv' },
                  'CVV'
                ),
                _react2.default.createElement('div', { className: 'input-wrapper', id: 'cvv' })
              )
            ),
            _react2.default.createElement(
              'div',
              { className: 'mt-3 d-flex align-items-center form-group' },
              _react2.default.createElement('input', { type: 'checkbox', id: 'primary', className: 'styled-checkbox' }),
              _react2.default.createElement(
                'label',
                { className: 'mb-0 ml-2', htmlFor: 'primary' },
                'Use as primary card'
              )
            )
          ),
          _react2.default.createElement('input', { id: 'button-pay', type: 'submit', value: 'Continue' })
        )
      );
    }
  }]);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(37), __webpack_require__(110)))
